...
SELECT VG.vg_id AS `id`, VG.vg_id AS `Уникальный id`, VG.name AS `название`, VG.active as `статус`, IFNULL(MAX(LC.change_date),"-") AS "пос. редакт."
FROM `virtualgood` VG LEFT OUTER JOIN changes LC ON VG.vg_id = LC.vg_id 
GROUP BY VG.vg_id
