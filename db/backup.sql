...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 24 2019 г., 14:24
...
ALTER TABLE `vg_processing_reports`
  ...
  ADD CONSTRAINT `vg_processing_reports_ibfk_3` FOREIGN KEY (`report_unique_key`) REFERENCES `reports` (`report_unique_key`) ON DELETE CASCADE ON UPDATE CASCADE;
